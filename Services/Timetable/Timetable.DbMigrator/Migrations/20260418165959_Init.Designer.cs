...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Timetable.Domain.AppointmentAggregate.Appointment", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Date", "Timetable.Domain.AppointmentAggregate.Appointment.Date#AppointmentDate", b1 =>
                        {
                            ...
                            b1.Property<DateTime>("DateTime")
                                .HasColumnType("timestamp with time zone")
                                .HasColumnName("date_date_time");

                            b1.Property<int>("DurationMinutes")
                                .HasColumnType("integer")
                                .HasColumnName("date_duration_minutes");
                        });
                    ...
                    b.HasIndex("SurgeryId")
                        .HasDatabaseName("ix_appointments_surgery_id");
            ...
            modelBuilder.Entity("Timetable.Domain.DoctorAggregate.Doctor", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Name", "Timetable.Domain.DoctorAggregate.Doctor.Name#Name", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("Timetable.Domain.AppointmentAggregate.Appointment", b =>
                {
                    b.HasOne("Timetable.Domain.DoctorAggregate.Doctor", "Doctor")
                        .WithMany()
                    ...
                    b.HasOne("Timetable.Domain.SurgeryAggregate.Surgery", "Surgery")
                        .WithMany()
                        .HasForeignKey("SurgeryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_appointments_surgeries_surgery_id");
